...
const TOMO_FARMING_ADDRESS = '0x5289d1a9C889b758269C3913136791b2D52d996A'

export { TOMO_SUPPORTED_POOL, SUPPORTED_POOL, FARMING_ABI, FARMING_ADDRESS, TOMO_FARMING_ADDRESS }
