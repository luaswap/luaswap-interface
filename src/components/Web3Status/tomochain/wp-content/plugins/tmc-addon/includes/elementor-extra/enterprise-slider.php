...
class Enterprise_Slider extends Widget_Base{
    public function get_name()
    {
      return 'tmc-enterprise-slider';
    }
    ...
    {
        return esc_html__('TMC Enterprise Slider', 'tmc');
    }
    ...
    */
    ...
    {
        // Tab Content
        $this->tmc_enterprise_tabs_option();
    }
    ...
    private function tmc_enterprise_tabs_option(){
        ...
        $repeater->add_control(
            ...
            [
              ...
              'type'      => Controls_Manager::TEXT,
              'default'     => __( '1', 'tmc' ),
              'placeholder'   => __( 'Type your number', 'tmc' ),
            ]
        );
        $repeater->add_control(
            't_title',
            [
              'label'     => __( 'Title', 'tmc' ),
              'type'      => Controls_Manager::TEXT,
              'default'     => __( 'Intergrated API', 'tmc' ),
              'placeholder'   => __( 'Type your number', 'tmc' ),
            ]
        );
        $repeater->add_control(
    ...
    protected function render()
    {
        ...
        if(isset($settings['tab_list']) && is_array($settings['tab_list'])):
            ...
            $i = $j = 0;
            ?>
            <div class="tmc-en-slider-widget">
                <div class="tmc-en-slider-wrap swiper-wrapper">
                <?php foreach($settings['tab_list'] as $value):
                    ...
                    <div class="tmc-flex-content">
                        <div class="tmc-tab-left enterprise-<?php echo $this->convert_to_slug($value['tab']);?>">
                        <img src="<?php echo esc_url($image);?>">
                        </div>
                        <div class="tmc-tab-right enterprise-<?php echo $this->convert_to_slug($value['tab']);?>">
