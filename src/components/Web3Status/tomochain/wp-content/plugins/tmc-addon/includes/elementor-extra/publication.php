...
class Publication extends Widget_Base {

	/**
	 * Get widget name.
	 */
	public function get_name() {
		return 'tmc-publication';
	}
	...
	public function get_title() {
		return esc_html__( 'TMC Publication', 'tmc' );
	}
	...
	*/
	...
	protected function _register_controls() {
		// Tab Content
		$this->tmc_publication_option();
		$this->tmc_publication_content();
	}

	/*
	* Recent New Option
	*/
	private function tmc_publication_option(){
		$this->start_controls_section(
			'tmc_publication_section',
			[
		...
		$this->add_control(
			...
			[
				...
				'multiple' 	=> true,
				'options' 	=> $this->get_post_type_categories('publication_cat'),
			]
		);
	 ...
	 */
	private function tmc_publication_content() {
		$this->start_controls_section(
			'tmc_publication_content',
			[
	...
	protected function render() {
		...
		<div class="tmc-publication-widget">
			<div class="tmc-publication-content">
				<?php
				if ( $query->have_posts() ):
					while ( $query->have_posts() ):
						$query->the_post();
						$date = get_the_date(get_option( 'date_format' ));
						$terms = get_the_terms( get_the_ID(), 'publication_cat' );?>
						<div class="post-item">
							<div class="post-featured" style="background-image: url(<?php echo get_the_post_thumbnail_url();?>)">
							...
							<div class="post-content">
								<div class="post-terms">									
									...
									if ( $terms && ! is_wp_error( $terms ) ) :?>
										<span class="term-title"><?php esc_html_e('Category: ','tmc');?></span>
									    <?php foreach ( $terms as $term ) {?>
									    	<span class="term-item"><a href="<?php echo get_term_link($term->term_id,'publication_cat')?>"><?php echo esc_html($term->name);?></a></span>
										<?php }?>
