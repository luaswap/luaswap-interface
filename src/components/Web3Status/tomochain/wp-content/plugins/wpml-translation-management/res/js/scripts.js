...
function icl_tm_assign_translator_request(job_id, translator_id, select, jobType) {
    ...
    function iclTmSelectAllJobsBasket(caller) {
        if (jQuery(caller).prop('checked')) {
            jQuery('#icl-translation-jobs-basket').find(':checkbox').prop('checked', true);
            jQuery('#icl-tm-jobs-cancel-but').removeAttr('disabled');
        } else {
            jQuery('#icl-translation-jobs-basket').find(':checkbox').prop('checked', false);
	...
	function iclTmSelectAllJobsSelection() {
     if (jQuery(this).prop('checked')) {
         jQuery('#icl-translation-jobs').find(':checkbox').prop('checked', true);
         jQuery('#icl-tm-jobs-cancel-but').removeAttr('disabled');
     } else {
         jQuery('#icl-translation-jobs').find(':checkbox').prop('checked', false);
         jQuery('#icl-tm-jobs-cancel-but').attr('disabled', 'disabled');
     }
 }
