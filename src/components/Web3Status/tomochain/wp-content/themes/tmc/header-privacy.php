...
<head>
    ...
    <script type="text/javascript" src="<?php echo esc_url(TMC_THEME_URI . '/assets/libs/set-cookie/cookie.js'); ?>"></script>
    <?php wp_head(); ?>
    <link rel="stylesheet" href="<?php echo esc_url(TMC_THEME_URI . '/assets/libs/scroll-fullpage/fullpage.css'); ?>">
</head>
