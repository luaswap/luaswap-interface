...
export const STAKE_FEE = '0.05%' // Only used for display on string
export const LP_FEE = '0.35%' // Only used for display on string
export const SWAP_FEE = '0.4%' // Only used for display on string
...
export function computeTradePriceBreakdown(
  ...
  const realizedLPFeeAmount =
    ...
    (trade.inputAmount instanceof TokenAmount
      ...
      : trade.inputAmount.currency === TOMO
      ? CurrencyAmount.tomo(realizedLPFee.multiply(trade.inputAmount.raw).quotient)
