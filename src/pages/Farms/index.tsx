    ...
    <>
      ...
      <Box className="mt-4">
        ...
        <StyledInfo>
          ...
          <div>
            <b>Pro Tip</b>: Stake to any pool and earn <b>{EARN_LUA_REWARD} LUA</b> rewards until{' '}
            <a href="https://etherscan.io/block/countdown/11232600" target="_blank" style={{ color: '#ffffff' }}>
              {TIME_EARN_LUA_REWARD}
            </a>
          </div>
        </StyledInfo>
        <Spacer size="lg" />
